...
In a helium ground state, there are two electrons in this lowest
...
\includegraphics[width=1.3in]{quantum_statistics/five_particles.eps}
\end{minipage}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=4.8in]{quantum_statistics/quantum_statistics_table.eps}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=4.8in]{quantum_statistics/photon_process.eps}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=4.4in]{quantum_statistics/laser_cavity.eps}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=3in]{quantum_statistics/three_level_laser.eps}
...
\begin{figure}[tbp]
\begin{center}
\includegraphics{quantum_statistics/meissner.eps}
...
%\section{Limits of superconductivity}
%
...
%\includegraphics[width=5cm]{quantum_statistics/superconductor_resistance.eps}
%\caption{Resistance versus temperature for a superconductor}
%\label{fig:superconductor_resistance}
%\end{minipage}
%\hfill
%\begin{minipage}[t]{6.0cm}
%\includegraphics[width=5cm]{quantum_statistics/Bc_vs_T.eps}
...
\begin{problem}
  ...
  \begin{figure}[h]
    \begin{center}
      \includegraphics[width=3.5in]{additional_problems/transitions.eps}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=2.4in]{quantum_statistics/ruby_laser.eps}
